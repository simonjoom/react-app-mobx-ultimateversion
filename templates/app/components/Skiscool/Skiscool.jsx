...
<div className="xs-col-12 sm-col-6 mx-auto">
  ...
  <Link className="border detailsbu"  to="/" onClick={(e)=> {e.preventDefault();}} width="100%" hoverColor="#aa062F" backgroundColor="#6FAFE9" data-content={it_1_c} title={t_1} icon={<i className="mb3 fa fa-question-circle-o" />}>
